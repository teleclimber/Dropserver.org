...
- On a Linux host, acquire the [latest version of ds-host](https://github.com/teleclimber/Dropserver/releases/) and [Deno](https://deno.land).
...
If you would like an additional layer of security you may want to try [using Bubblewrap](/docs/bubblewrap).
