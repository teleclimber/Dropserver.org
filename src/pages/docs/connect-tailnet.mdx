...
A [Tailscale](https://tailscale.com) [tailnet](https://tailscale.com/kb/1136/tailnet) is a private network that lets you connect your devices to other computers, such as your Dropserver instance, from anywhere without exposing them to the public internet.
...
- No need to get a static IP or dynamic DNS
...
There are open source self-hosted alternatives to Tailscale: [Headscale](https://headscale.net/stable/) and [Ionscale](https://jsiebens.github.io/ionscale/). There may be others too. See below for more info on using these.
